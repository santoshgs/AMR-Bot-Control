...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBtnFwd = (Button) findViewById(R.id.buttonFwd);
		...
		mBtnFwd.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				try {
					mBTSocket.getOutputStream().write(fwdByte);
				} catch(IOException e){
					e.printStackTrace();
				}
			}
		...
		mBtnRev.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				try {
					mBTSocket.getOutputStream().write(revByte);
				} catch(IOException e){
					e.printStackTrace();
				}
			}
		...
		mBtnLeft.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					mBTSocket.getOutputStream().write(leftByte);
				} catch(IOException e){
					e.printStackTrace();
				}
			}
		...
		mBtnRight.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					mBTSocket.getOutputStream().write(rightByte);
				} catch(IOException e){
					e.printStackTrace();
				}
			}
